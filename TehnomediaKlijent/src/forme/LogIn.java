...
public class LogIn extends javax.swing.JFrame {
    ...
    RukovodilacSektoraNabavke rukovodilac;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lozinka rukovodioca sektora nabavke:");
    ...
    private void btnPrijavaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrijavaActionPerformed
        ...
        try {
            rukovodilac = (RukovodilacSektoraNabavke) Kontroler.vratiInstancu().ulogujKorisnika(lozinka);
            GlavnaFrm glavna = new GlavnaFrm(rukovodilac);
            JOptionPane.showMessageDialog(rootPane, "Uspesno ste se prijavili na sistem!","Uspesna prijava", JOptionPane.INFORMATION_MESSAGE);
